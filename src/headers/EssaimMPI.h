...
#ifndef SRC_HEADERS_ESSAIMMPI_H_
#define SRC_HEADERS_ESSAIMMPI_H_
...
template <typename TypeVector, unsigned dimension>
class EssaimMPI : public BaseEssaim<TypeVector,dimension> {
private:
...
public:
	EssaimMPI();
	EssaimMPI(const unsigned nb_particules, const std::vector<TypeVector> &min_espace, const std::vector<TypeVector> &max_espace, Objectif<TypeVector, dimension>& obj);
	EssaimMPI (const EssaimMPI &autre);
	...
	std::unique_ptr<std::vector<TypeVector>> algoEssaim(Objectif<TypeVector, dimension>& obj, unsigned max_it, unsigned int seed);
...
//###### Constructeurs
template <typename TypeVector, unsigned dimension>
EssaimMPI<TypeVector,dimension>::EssaimMPI() : BaseEssaim<TypeVector,dimension>() {

}

template <typename TypeVector, unsigned dimension>
EssaimMPI<TypeVector, dimension>::EssaimMPI(const unsigned nb_particules, const std::vector<TypeVector> &min_espace, const std::vector<TypeVector> &max_espace, Objectif<TypeVector, dimension>& obj) : EssaimMPI<TypeVector, dimension>() {
	initEssaim(nb_particules, min_espace, max_espace, obj);
}

template <typename TypeVector, unsigned dimension>
EssaimMPI<TypeVector, dimension>::EssaimMPI (const EssaimMPI &autre) {
	(*this) = autre;
}

template <typename TypeVector, unsigned dimension>
unsigned EssaimMPI<TypeVector, dimension>::taille() const {
	return essaim().size();
}

//###### Methodes
template<typename TypeVector, unsigned dimension>
void EssaimMPI<TypeVector, dimension>::initEssaim(const unsigned nb_particules, const std::vector<TypeVector> min_espace, const std::vector<TypeVector> max_espace, Objectif<TypeVector, dimension>& obj) {
	srand(time(NULL));
...
template<typename TypeVector, unsigned dimension>
std::unique_ptr<std::vector<unsigned>> EssaimMPI<TypeVector, dimension>::recupVoisins(const unsigned taille, const unsigned pos, const unsigned nb_part) const {
...
template<typename TypeVector, unsigned dimension>
void EssaimMPI<TypeVector, dimension>::fonctionDePositionActuelle(Particule<TypeVector, dimension>& p, Objectif<TypeVector, dimension>& obj
...
template<typename TypeVector, unsigned dimension>
void EssaimMPI<TypeVector, dimension>::communicationVoisins(Particule<TypeVector, dimension>& p, std::vector<unsigned>& vect_voisins) {
...
template<typename TypeVector, unsigned dimension>
void EssaimMPI<TypeVector, dimension>::majMeilleurObjectif(Particule<TypeVector, dimension>& p, TypeVector f_meilleure_pos_e, Objectif<TypeVector, dimension>& obj) {
...
void EssaimMPI<TypeVector, dimension>::majMeilleuresPositions(Objectif<TypeVector, dimension>& obj) {
...
template<typename TypeVector, unsigned dimension>
void EssaimMPI<TypeVector, dimension>::majVitesse(Particule<TypeVector, dimension> &p, unsigned max_it, unsigned i_enCours) {
...
template<typename TypeVector, unsigned dimension>
void EssaimMPI<TypeVector, dimension>::deplacementParticule(Particule<TypeVector, dimension> &p, Objectif<TypeVector, dimension>& obj) {
...
template<typename TypeVector, unsigned dimension>
void EssaimMPI<TypeVector, dimension>::deplacements(unsigned max_it, Objectif<TypeVector, dimension>& obj) {
	unsigned taille_e = essaim().size();
...
template<typename TypeVector, unsigned dimension>
std::unique_ptr<std::vector<TypeVector>> EssaimMPI<TypeVector,dimension>::algoEssaim(Objectif<TypeVector, dimension>& obj, unsigned max_it, unsigned int seed) {
	unsigned i {0};
	unsigned j {0};
...
#endif /* SRC_HEADERS_EssaimMPI_H_ */
